...
(function () {
  ...
  var columns = [
    ...
    { label: 'Tipo', sortable: true, search: true },
    { label: 'Código externo', sortable: true, numeric: true, search: true, minChars: 1 },
    { label: 'Alcance', sortable: true, search: true },
    { label: 'Empaque', sortable: true, numeric: true, search: true, minChars: 1 },
    { label: 'Cantidad', sortable: true, numeric: true, search: true, minChars: 1 },
  ...
  var PENCIL_SVG =
    '<svg width="12" height="12" viewBox="0 0 12 12" fill="rgb(255,255,255)" aria-hidden="true">' +
    '<path d="M 0 9.5 L 0 12 L 2.5 12 L 9.9 4.6 L 7.4 2.1 Z" fill-rule="nonzero"></path>' +
    '<path d="M 11.7 2.8 L 9.2 0.3 C 8.9 0 8.4 0 8.1 0.3 L 6.7 1.7 L 10.3 5.3 L 11.7 3.9 ' +
    'C 12 3.6 12 3.1 11.7 2.8 Z" fill-rule="nonzero"></path></svg>';
